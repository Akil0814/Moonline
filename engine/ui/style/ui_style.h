...
struct ButtonStyle
{
    Color _idle_color{ 180, 180, 180, 255 };
    Color _hovered_color{ 200, 200, 200, 255 };
    Color _pushed_color{ 130, 130, 130, 255 };
    Color _frame_color = colors::black;
...
struct LabelStyle
{
    ...
    Color _background_color = colors::transparent;
...
struct PanelStyle
{
    Color _background_color{ 24, 24, 32, 220 };
    Color _border_color{ 220, 220, 220, 255 };
...
{
    Color _track_color{ 32, 40, 56, 180 };
    Color _thumb_color{ 126, 156, 196, 255 };
...
{
    BarStyle _bar_style;
    Color _thumb_color{ 232, 240, 250, 255 };
    Color _text_color{ 244, 244, 248, 255 };
...
{
    Color _text_color{ 244, 244, 248, 255 };
    Color _background_color{ 32, 42, 58, 220 };
    Color _focused_background_color{ 52, 78, 116, 235 };
    Color _border_color{ 112, 140, 180, 255 };
};

struct TextInputStyle
{
    Color _text_color{ 244, 244, 248, 255 };
    Color _placeholder_color{ 142, 154, 170, 255 };
    Color _background_color{ 28, 36, 52, 220 };
    Color _border_color{ 110, 140, 182, 255 };
    Color _focused_border_color{ 166, 208, 255, 255 };
    Color _caret_color{ 248, 248, 252, 255 };
    int _padding = 10;
};
