...
UiTheme make_loading_blue_theme()
{
    ...
    theme._list_panel._background_color = elysia::core::Color{ 16, 30, 52, 222 };
    theme._list_panel._draw_border = true;

    theme._default_label._text_color = elysia::core::colors::ui_text_default;
    theme._title_label = theme._default_label;
    theme._title_label._text_color = elysia::core::colors::ui_text_title;
    ...
    theme._subtitle_label._text_color = elysia::core::colors::ui_text_subtitle;
    ...
    theme._muted_label._text_color = elysia::core::colors::ui_text_muted;
    ...
    theme._primary_button._hovered_color = elysia::core::Color{ 44, 94, 162, 255 };
    theme._primary_button._pushed_color = elysia::core::Color{ 16, 44, 88, 255 };

    theme._danger_button = theme._default_button;
    theme._danger_button._idle_color = elysia::core::Color{ 108, 34, 42, 255 };
    theme._danger_button._hovered_color = elysia::core::Color{ 146, 50, 60, 255 };
    ...
    theme._scroll_bar._track_color = elysia::core::Color{ 10, 20, 34, 180 };
    theme._scroll_bar._thumb_color = elysia::core::Color{ 126, 182, 232, 255 };
    ...
    theme._slider._thumb_color = elysia::core::Color{ 238, 248, 255, 255 };
    ...
    theme._toggle._background_color = elysia::core::Color{ 20, 36, 58, 220 };
    theme._toggle._focused_background_color = elysia::core::Color{ 30, 58, 98, 235 };
    theme._toggle._border_color = elysia::core::Color{ 112, 160, 206, 255 };

    theme._text_input._text_color = theme._default_label._text_color;
    theme._text_input._placeholder_color = elysia::core::Color{ 128, 156, 182, 255 };
    theme._text_input._background_color = elysia::core::Color{ 12, 28, 48, 228 };
    theme._text_input._border_color = elysia::core::Color{ 102, 144, 192, 255 };
    theme._text_input._focused_border_color = elysia::core::Color{ 184, 224, 255, 255 };
    theme._text_input._caret_color = elysia::core::Color{ 244, 252, 255, 255 };
